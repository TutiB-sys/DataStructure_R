...
```{r}
student_name <- c("John", "Jake","Jilly")
student_grade_level <- c("Sopomore" , "Junior", " Senior")
student_class_grade <-c(65, 82, 89)

# create a data frame from these vectors, each vector is its own column
...
df$student_subject <- c( "Math", "History", "Chemsstry")
...
4.  Print the second column of both matrices.
    ...
    ```{r}
    # The the value 5  in to the matrix. 

    Array1[2,2,1]
    Array1[2,2,2]


    #The third row of the first matrix.
    Array1[3, ,1 ]
    #The second column of both matrices.
